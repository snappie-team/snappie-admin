...
class AchievementChecker
{
    ...
    protected function formatUnlockedAchievement(Achievement $achievement): array
    {
        return [
            ...
            'code' => $achievement->code,
            'name' => $achievement->name,
            'subtitle' => $achievement->additional_info['subtitle'] ?? null,
            'description' => $achievement->description,
            'icon_url' => $achievement->image_url,
            'type' => $achievement->type,
            'level' => $achievement->level,
            'criteria_action' => $achievement->criteria_action,
    ...
    public function getActiveChallenges(User $user): array
    {
        ...
        foreach ($challenges as $challenge) {
            ...
            $result[] = [
                ...
                'code' => $challenge->code,
                'name' => $challenge->name,
                'subtitle' => $challenge->additional_info['subtitle'] ?? null,
                'description' => $challenge->description,
                'icon_url' => $challenge->image_url,
                'type' => $challenge->type,
                'criteria_action' => $challenge->criteria_action,
                'criteria_target' => $challenge->criteria_target,
